...
const JourneyTimeline = () => {
  ...
  const milestones = [
    ...
    },
    {
      ...
      description: "Delegated the 5-days International Conference 'United Nations Responsible Business and Human Rights Forum, Asia-Pacific 2024' in Bangkok, Thailand. Engaged with diverse stakeholder representatives from South Asia & Asia-Pacific countries globally.",
    ...
    },
    {
      ...
      description: "Anumita introduced PRABHAVEE - Partner for Social Impact during ISDM's Annual Flagship Event 'Dialogue on Development Management'. Anumita also completed the Women on Boards Program (WoB) from Indian School of Development Management (ISDM) - Cohort 5. This enhanced our leadership capabilities and governance expertise.",
  ...
  },
  {
    ...
    description: "Launched and contributed to research initiatives fostering policy dialogue, academic collaboration, and evidence-based practice in social impact.",
  ...
  },
  {
    ...
    description: "Organized and participated in key events and workshops, including collaborations with the Young Leaders Council at AIMA to support professional growth.",
