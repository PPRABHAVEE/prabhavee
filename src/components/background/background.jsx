          ...
          <div className="md:col-span-2">
            <div className="bg-white rounded-xl shadow-md p-8 border border-gray-100 mb-8">
              ...
              <ul className="list-disc pl-5 space-y-3 text-gray-700 text-base text-left">
                ...
                <li>
                  <span className="font-semibold">NGRBC & National Action Plan (NAP):</span> India has released a zero draft of its <strong>National Action Plan (NAP) on Business and Human Rights</strong> following multi-stakeholder consultations. The <strong>Indian Institute of Corporate Affairs (IICA)</strong> published the <strong>2018 National Guidelines on Responsible Business Conduct (NGRBC), </strong>aligned with the <strong>2011 NVGs </strong>and <strong>UNGPs</strong>. We actively follow this evolving space and look forward to its implementation.
                </li>
                <li>
