...
const footer = () => {
  return (
    <>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-4 text-center md:text-left">
                  ...
                  <span>  P/ PRABHAVEE – Partner for Social Impact</span>
                </a>
                </div>
                  <div className="flex items-center">
      ...
      <footer className="bg-gray-200 border-t border-gray-200 py-8 pb-0">
        <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto text-center bg-gray-900 py-3 mt-6 flex items-center justify-center gap-4 flex-col md:flex-row">
          ...
          <a
            href="https://www.linkedin.com/in/deepshikha0512/"
            target="_blank"
            rel="noopener noreferrer"
